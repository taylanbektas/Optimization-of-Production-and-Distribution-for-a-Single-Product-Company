...
def constraint_D_T_1(model) :
    return sum(model.varX[i,41] for i in range (37,41)) == 2500
...
def constraint_D_C_1(model) :
    return sum(model.varX[i,42] for i in range (37,41)) == 2100
...
def constraint_D_B_1(model) :
    return sum(model.varX[i,43] for i in range (37,41)) == 1900
